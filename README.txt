...
V. Installation
   ...
   3) 'checkFormat_workflowPositionImage.png'
         Images for the workflow position section of the 'checkFormat_config.xml' file; to be put into the './galaxy-dist/static/images/' directory		 
		 
   4) 'checkFormat_wrapper.R'
